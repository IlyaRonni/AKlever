...
VK_CLEVER_SETTINGS = "VK Clever settings"
VVP_SETTINGS = "VVP settings"
NO_TOKEN = "no token"
VVP_SETTINGS_INFO = "To use this function, you need to sniff VVP packets. I recommend using Packet Sniffer."
VVP_USER_STATS = "VVP User Statistics"
VVP_USER_INFO = "VVP User Info"
VVP_NO_INFO = "Can't enable because user token and user id are not set up."
VVP_USER_TOKEN_INFO = "VVP User Token"
VVP_USER_ID_INFO = "VVP User ID"
